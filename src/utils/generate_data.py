...
def preprocess_dataset_old(x_train, y_train, x_test, y_test):
    '''
    1. Normalize images
    2. Set label as one-hot encoded vector
    3. Subtract pixel mean
...
def get_cifar10_old(**kwargs):
    ...
    x_train, y_train, x_test, y_test = preprocess_dataset_old(x_train, y_train, x_test, y_test)
